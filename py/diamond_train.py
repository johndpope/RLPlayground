...
def Train():
  m = model.Model(observations_dims=args.world_size, observations_rows=3, 
    observations_cols=3, actions_dims=2,  hidden_dims=[10], 
    lr=args.learning_rate, reg_factor=args.regularization, loss="softmax")
